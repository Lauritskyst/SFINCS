...
./configure FCFLAGS="-mp=multicore -Minfo=mp -stdpar=multicore -gpu=nomanaged -fast -O3 -gpu=ccall -DSIZEOF_PTRDIFF_T=999" FC=nvfortran --disable-shared --disable-openmp --prefix=/home/laurits-andreasen/sfincs/nvfortran_cpu_omp
